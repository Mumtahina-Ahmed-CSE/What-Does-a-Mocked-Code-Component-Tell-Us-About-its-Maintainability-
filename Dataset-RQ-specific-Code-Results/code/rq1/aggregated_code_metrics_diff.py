...
#selected_features = ["SLOCStandard", "NVAR", "NCOMP", "Mcclure", "McCabe",
                   # "IndentSTD", "MaximumBlockDepth", "totalFanOut", "Length",
                   # "Parameters", "LocalVariables"]

selected_features = ["SLOCStandard", "NVAR", "NCOMP", "Mcclure", "McCabe",
                     "IndentSTD", "MaximumBlockDepth", "totalFanOut", "Length",
                     "Parameters", "LocalVariables", "Readability", "SimpleReadability", "MaintainabilityIndex"]
                     

selected_features = ["MaximumBlockDepth"]

#selected_features = ["MaintainabilityIndex"]

#selected_features = ["Readability", "SimpleReadability"]

# Output directory
OUTPUT_DIR = "/Users/mumtahinaahmed/Desktop/Mockito/Mockito-2025/results/RQ1/aggregated"
...
def draw_graph(feature, method_data):
    ...
    configs = {
        ...
        #"xlim": (1, None),  # 👈 ensures X-axis starts from 60
        "output_path": os.path.join(OUTPUT_DIR, f"{feature}.png")  # <-- Changed to .png
    }

    #graphss.draw_line_graph_multiple_with_x(X, Y, configs) # 
    graphs.draw_line_graph_multiple_with_x(X, Y, configs) #Size, totalFanOut, Halstead Length, "LocalVariables"
    #graph.draw_line_graph_multiple_with_x(X, Y, configs) #Readability, SimpleReadability
