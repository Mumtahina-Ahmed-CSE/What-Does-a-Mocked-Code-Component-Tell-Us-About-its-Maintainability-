...
# Updated paths for Impacted and Unmocked methods
IMPACTED_PATH = "/Users/mumtahinaahmed/Desktop/Mockito/Mockito-2025/data/cleaned/ImpactedByMocking/"
UNMOCKED_PATH = "/Users/mumtahinaahmed/Desktop/Mockito/Mockito-2025/data/cleaned/UnmockedMethod/"

selected_features = [
    "SLOCStandard", "Readability", "SimpleReadability", "NVAR", "NCOMP",
    "Mcclure", "McCabe", "IndentSTD", "MaximumBlockDepth", "totalFanOut",
    "Length", "MaintainabilityIndex", "Parameters", "LocalVariables"
]
...
def calculate_per_project(feature, indexes):
    ...
    unmocked_data = extract_values(UNMOCKED_PATH, feature, indexes)

    common_files = set(impacted_data.keys()) & set(unmocked_data.keys())

    for file in common_files:
        x = impacted_data[file]
        y = unmocked_data[file]
        if not x or not y:
            continue
        total_projects += 1
...
if __name__ == "__main__":
    sample_file = os.path.join(IMPACTED_PATH, os.listdir(IMPACTED_PATH)[0])
